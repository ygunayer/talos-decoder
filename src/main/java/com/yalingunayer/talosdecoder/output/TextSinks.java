...
public class TextSinks {
    ...
    public static ElasticSearchTextSink elastic(String hostname, int port, String indexName) throws UnknownHostException {
        return new ElasticSearchTextSink(hostname, port, indexName);
    }
